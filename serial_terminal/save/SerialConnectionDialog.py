...
class SerialConnectionDialog(tk.Toplevel):
    def __init__(self, parent):
        ...
        # position_right = int(parent_x + (parent_width / 2) - (dialog_width / 2))
        # position_down = int(parent_y + (parent_height / 2) - (dialog_height / 2))
        #
        # # Set the geometry of dialog
        # self.geometry(f"{dialog_width}x{dialog_height}+{position_right}+{position_down}")
